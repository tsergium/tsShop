...
class Admin_Form_Editpassword extends Zend_Form
{
	...
	public function editpassword(Default_Model_AdminUser $operator)
	{
		...
		$oldPassword->setAttribs(array('autocomplete'=>'off', 'class'=>'validate[required,minSize[6],maxSize[20]]'));
        ...
        $password->setAttribs(array('class'=>'validate[required,minSize[6],maxSize[20]] ', 'autocomplete'=>'off', 'oncontextmenu'=>'return false', 'ondrop'=>'return false', 'onpaste'=>'return false'));
