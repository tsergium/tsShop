...
{
	protected $_name    = 'ts_delivery_payment';
	protected $_primary = 'id';
}
class Default_Model_DeliveryPayment
{
    protected $_id;
	protected $_name;
	protected $_created;
    ...
    public function __set($name, $value)
    {
        ...
        if(('mapper' == $name) || !method_exists($this, $method)) {
            throw new Exception('Invalid '.$name.' delivery payment property '.$method);
        }
        $this->$method($value);
    }
    ...
    public function getMapper()
    {
        if(null === $this->_mapper) {
            $this->setMapper(new Default_Model_DeliveryPaymentMapper());
        }
        return $this->_mapper;
    }
...
class Default_Model_DeliveryPaymentMapper
{
    ...
    public function find($id, Default_Model_DeliveryPayment $model)
    {
    ...
    public function save(Default_Model_DeliveryPayment $model)
    {
        $data = array(
			'name'					=> $model->getName(),
        );
